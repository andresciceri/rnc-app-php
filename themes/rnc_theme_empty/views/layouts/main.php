		...
		<div class="">
			...
			<div class="">
				...
				<ul>
					...
					<p style="font-size: 1em; margin-bottom: 50px;" class="p-footer">Instituto de Investigación de Recursos Biológicos Alexander Von Humboldt · Ministerio de Medio Ambiente de Colombia · SIB Colombia</p>
			</div>
			</div>
