...
<body>
				...
				<div class='menu_conteneur_menu'>
					<div class='menu_rubrique'>
						<a href='#'>Iniciar Sesion</a>
							<div class='menu_sousmenu'><div class='menu_pagesousmenu'>
								<a href='http://rnc.humboldt.lumon.com.co/index.php/admin/login' target='_blank'>Ingresar</a>
							</div>
							<div class='menu_pagesousmenu'>
								<a href='http://rnc.humboldt.lumon.com.co/index.php/entidad/solicitud' target='_blank'>Solicitar Usuario</a>
							</div>
					</div>
				</div>
	...
	<div class="row">
		<div class="padding-bottom:20px;">
			...
			<div class="padding-bottom:20px;">
				<ul>
					<p style="font-size: 1em;" > Coordinan:</p>
				...
				<ul>
					...
					<p style="font-size: 1em; padding-bottom: 50px;" class="p-footer">2014 · Instituto de Investigación de Recursos Biológicos Alexander Von Humboldt · Ministerio de Medio Ambiente de Colombia · SIB Colombia</p>
			</div>
			</div>
