...
class Registros extends CActiveRecord
{
	...
	*/
	...
	public function listarFolderHistoricos($folder = ""){
		$datos = array();
		$dirPath	= "..".DIRECTORY_SEPARATOR."rnc_files".DIRECTORY_SEPARATOR."Registro_Colecciones_Biologicas_Historicos";
	...
	public function listarFolderCertificados($folder = ""){
		$datos = array();
		$dirPath	= "..".DIRECTORY_SEPARATOR."rnc_files".DIRECTORY_SEPARATOR."Certificados";
