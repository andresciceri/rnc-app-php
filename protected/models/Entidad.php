...
class Entidad extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
				array('tipo_titular,titular,tipo_nit,nit,representante_legal,tipo_id_rep,representante_id,direccion,telefono,email,departamento_id,ciudad_id,tipo_institucion_id,colecciones', 'required'),
